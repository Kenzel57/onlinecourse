...
# -----------------------------------------------------------------
# Task 1 — NEW MODELS: Question, Choice, Submission
# -----------------------------------------------------------------

class Question(models.Model):
    """A multiple-choice exam question linked to a Course."""
    course = models.ForeignKey(Course, on_delete=models.CASCADE)
    content = models.CharField(max_length=200)          # question text
    grade = models.FloatField(default=50.0)             # points this question is worth

    def __str__(self):
        return self.content

    def is_get_score(self, selected_ids):
        """Return True if ALL correct choices (and ONLY correct choices) were selected."""
...
class Choice(models.Model):
    ...
    content = models.CharField(max_length=200)          # answer text
...
class Submission(models.Model):
    """Records which Choices a learner submitted for a given Enrollment."""
